...
### Platform Resource Claim (PRC)
| 문서 | 설명 |
|------|------|
| [PRC Specification](docs/platform-resource-claim-spec.md) | PRC 전체 규격 — K8s PVC 모델, Saga 실행, Dual Driver |
| [PRC Provider Reference](docs/prc-provider-reference.md) | 9개 Provider 상세 — Config, Credentials, 프로비저닝 동작 |

### 모듈 개발 규격
| 문서 | 설명 |
|------|------|
| [Module Spec](docs/module-spec.md) | 모듈 기본 스펙 — module.yaml, K8s 리소스, 환경변수 |
| [Module UI Spec](docs/module-ui-spec.md) | 모듈 UI 통합 v2 — 하이브리드 A(Foundation 내장)/C(Module iframe) 아키텍처, 동적 메뉴, ModuleSector |
| [Module SDK Spec](docs/module-sdk-spec.md) | @polyon/module-sdk — iframe ↔ 호스트 통신 SDK (인증, 테마, 네비게이션, API) |
| [PostMessage Protocol](docs/postmessage-protocol-spec.md) | Console ↔ Module iframe postMessage 프로토콜 상세 |
...
| [User API Spec](docs/user-api-spec.md) | 사원용 API 규격 — 파일/휴지통/공유/검색/버전/할당량, WebDAV, 공유 링크 |
...
| [Odoo Module RFP](docs/rfp-odoo.md) | Odoo(ERP/HR/회계) 모듈 커스텀 설계서 — addon 3개 + Core 동기화 |

### SDK
| SDK | 언어 | 설치 |
|-----|------|------|
| [PolyON-sdk-go](https://github.com/jupiter-ai-agent/PolyON-sdk-go) | Go | `go get github.com/jupiter-ai-agent/PolyON-sdk-go` |
| [PolyON-sdk-python](https://github.com/jupiter-ai-agent/PolyON-sdk-python) | Python | `pip install polyon-sdk` |
